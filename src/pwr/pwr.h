...
extern "C" {
	...
	PWR_Request PWR_ReqCreateCallback( PWR_Cntxt, PWR_Status, Callback callback, void* data );
	int PWR_ReqDestroy( PWR_Request );

	int PWR_ReqWait( PWR_Request );

	int PWR_ObjAttrGetValues_NB( PWR_Obj, int count, PWR_AttrName name[], void* buf, PWR_Time [], PWR_Request );

	int PWR_ObjAttrSetValues_NB( PWR_Obj, int count, PWR_AttrName name[], void* buf, PWR_Request );
	...
	int PWR_ObjAttrGetSamples( PWR_Obj, PWR_AttrName name, PWR_Time* start, double period, unsigned int count, void* buf );
	...
	int PWR_ObjAttrGetSamples_NB( PWR_Obj, PWR_AttrName name, PWR_Time* start, double period, unsigned int* count, void* buf,  PWR_Request );
